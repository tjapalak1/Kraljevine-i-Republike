...
public class GeografijaDAO {
    ...
    public void dodajDrzavu(Drzava drzava) {
        try {
            ...
            if(drzava.getClass()==Drzava.class)
                dodajDrzavuUpit.setInt(4,1);
            else if (drzava.getClass()==Republika.class)
                dodajDrzavuUpit.setInt(4,2);
            else
                dodajDrzavuUpit.setInt(4,3);
    ...
    public void izmijeniDrzavu(Drzava drzava) {
        try {
            ...
            if(drzava.getClass()==Drzava.class)
                promijeniDrzavuUpit.setInt(3,1);
            else if (drzava.getClass()==Republika.class)
                promijeniDrzavuUpit.setInt(3,2);
            else
               promijeniDrzavuUpit.setInt(3,3);
